    ...
    for subj in subjects:
        for action_idx in np.arange(len(actions)):
            ...
            if not (subj == 5):
                ...
                if test_manner == "256":
                    # 随机取 256 个
                    fs_sel1, fs_sel2 = find_indices_srnn(num_frames1, num_frames2, seq_len, sample_num=256)
                if test_manner == "8":
                    # 随机取 8 个
                    fs_sel1, fs_sel2 = find_indices_srnn(num_frames1, num_frames2, seq_len, sample_num=8)
